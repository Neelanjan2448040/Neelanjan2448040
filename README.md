...
### MSc Data Science @ Christ University | AI & Data Science Developer

I am a passionate **Data Science & AI enthusiast** and an open-source contributor with a strong foundation in Statistics. I specialize in building **end-to-end Intelligent Applications**, ranging from complex NLP pipelines and Predictive Analytics to modern **Full-Stack AI systems** using **FastAPI** and **React**. 

---

## 🚀 Recent Focus & Learnings
Lately, I've been mastering **Product-Grade AI Engineering**:
- **Backend**: Architecting high-performance APIs with **FastAPI** and Pydantic.
- **Infrastructure**: Containerizing multi-service applications using **Docker**.
- **Orchestration**: Managing **Monorepo** structures for seamless development.
- **LLMs**: Integrating **Groq LPU** inference for ultra-fast AI interactions.
...
<table>
  <tr>
    <td valign="top" width="50%">
      ...
      <img src="https://img.shields.io/badge/NLP-0A74DA?style=flat-square&logo=data-robot&logoColor=white" alt="NLP" />
    </td>
    <td valign="top" width="50%">
...
### 🚀 Campus-AI: Multi-Agent Management Platform (2025)
- **Concept:** A full-stack monorepo application for student & faculty management with AI automation.
- **Tech:** FastAPI, React, Docker, Groq SDK, MySQL, MongoDB.
